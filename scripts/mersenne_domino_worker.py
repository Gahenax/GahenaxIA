...
# Path to high-performance Rust worker
RUST_WORKER_EXE = Path(__file__).parent.parent / "OEDA_HodgeRigidity" / "tools" / "mersenne-worker-rs" / "mersenne-worker-rs.exe"
...
def run_block(
    ...
    # ... (skipping some logic for brevity in this replace block, 
    # but the tool will handle the full replacement accurately)
    # Actually, I'll just keep the original Python logic as fallback inside the replacement.
